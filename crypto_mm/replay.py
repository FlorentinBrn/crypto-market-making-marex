...
python -m crypto_mm.replay --data-dir data --speed inf --no-console
python -m crypto_mm.replay --data-dir data --bench-latency
```
...
def main() -> None:
    ...
    if settings.render_console:
        ...
        from .console import build_placeholder
